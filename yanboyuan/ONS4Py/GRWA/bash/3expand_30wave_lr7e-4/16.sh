...
srun python -u ../../main.py --mode learning --cnn expandsimplenet --num-steps 8 --step-over one_service \
		--net 6node.md --wave-num 30 --rou 8 --miu 1000 --max-iter 3000 --save-interval 500 --file-prefix "../../resources" \
			--k 1 --weight None --workers 16 --steps 10e7 --base-lr 7e-4 \
